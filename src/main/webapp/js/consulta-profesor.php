				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="consulta-profesor.php">Ver Profesor (borrar)</a></li>
						
						</ul></li>
					<li class="active"><a href="consulta-profesor.php">Ranking de profesores</a></li>
				</ul>
                ...
                <div class="container">
                    ...
                    <table  class="table table-hover">
                        ...
                        <tr>
                             ...
                             <td>
                                 <a href="http://ratingtapp.co.nf/profesor.php?id=<?php echo $profes['id']?>">
