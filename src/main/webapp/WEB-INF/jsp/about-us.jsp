				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-member">
							<div class="team-member-image"><img src="img/team/imgAndrea.jpg" alt="Andrea"></div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-member">
							<div class="team-member-image"><img src="" alt="Carlos"></div>
							<div class="team-member-info">
								<ul>
									<li class="team-member-name">
										Carlos Garcia
									...
									<li>Diseñador y programador Web</li>
								</ul>
							</div>
						</div>
					</div>
